...
// const char* ssid = "mckc4393-2FN";
// const char* password = "2727fccef1b9d";

const char* ssid = "mckc4393-3F2G";
const char* password = "8e8ea723ca9fc";
...
void post(float value) {
  HTTPClient http;
  http.begin("https://script.google.com/macros/s/AKfycbyW955s8_AHBy2RXn2USTYZPXl7I7SnQIHZECAaRppSdHDXVIuKZePWhwNqHOmINWBO/exec");
